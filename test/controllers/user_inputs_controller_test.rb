...
class UserInputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_input" do
    assert_difference('UserInput.count') do
      post user_inputs_url, params: { user_input: { csv: @user_input.csv, num_of_columns: @user_input.num_of_columns } }
    end
  ...
  test "should update user_input" do
    patch user_input_url(@user_input), params: { user_input: { csv: @user_input.csv, num_of_columns: @user_input.num_of_columns } }
